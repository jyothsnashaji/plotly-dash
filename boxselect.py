...
app.layout=html.Div([
    dcc.Graph(id='plot',figure={'data':[go.Scatter(x=df['x'],y=df['y'],mode='markers')],'layout':go.Layout(hovermode='closest')}),
    html.Div([html.H1(id='density')])])
